---
title: "25 道 MyBatis 面试题"
date: 2021-03-11T07:37:44+08:00
draft: false
---
...
25 道 MyBatis 面试题
 	...
 	- **[MyBatis 与 Hibernate 有哪些不同？](#e)**

 	- **[#{}和${}的区别是什么？](#f)**

 	- **[当实体类中的属性名和表中的字段名不一样 ，怎么办 ？](#h)**

 	- **[模糊查询 like 语句该怎么写?](#j)**

 	- **[Mapper 接口的工作原理是什么？Mapper 接口里的方法，参数不同时，方法能重载吗？](#k)**

 	- **[Mybatis 是如何进行分页的？分页插件的原理是什么？](#l)**

 	- **[Mybatis是如何将sql执行结果封装为目标对象并返回的？都有哪些映射形式？](#m)**

 	- **[如何执行批量插入?](#n)**

 	- **[如何获取自动生成的(主)键值?](#o)**

 	- **[[在 mapper 中如何传递多个参数?](#p)**

 	- **[Mybatis 动态 sql 有什么用？执行原理？有哪些动态 sql？](#q)**

 	- **[Xml 映射文件中，除了常见的 select|insert|updae|delete 标签之外，还有哪些标签？](#r)**

 	- **[Mybatis 的 Xml 映射文件中，不同的 Xml 映射文件，id 是否可以重复？](#s)**

 	- **[为什么说 Mybatis 是半自动 ORM 映射工具？它与全自动的区别在哪里？](#t)**

 	- **[一对一、一对多的关联查询 ？](#u)**

 	- **[MyBatis 实现一对一有几种方式?具体怎么操作的？](#v)**

 	- **[Mybatis 是否支持延迟加载？如果支持，它的实现原理是什么？](#w)**

 	- **[Mybatis 的一级、二级缓存](#x)**

 	- **[什么是 MyBatis 的接口绑定？有哪些实现方式？](#y)**

 	- **[使用 MyBatis 的 mapper 接口调用时有哪些要求？](#z)**

 	- **[简述 Mybatis 的插件运行原理，以及如何编写一个插件](#g)**
...
## MyBatis 框架适用场合
 	...
 	- 对性能的要求很高，或者需求变化较多的项目，如互联网项目，MyBatis 将是 不错的选择
